      ...
      <div className="container py-5">
        <div className="row" style={{marginLeft: "0px"}}>
          <div className="col-md-3">
            <b><label style={{float: "left", position: "relative", top: "15%", marginRight: "10px"}}><i class="fa fa-solid fa-tags"></i> Category</label></b>
            <select style={{backgroundColor: "#0a0908", color: "#F2F4F3", width: "150px"}}
          ...
          <div className="col-md-3">
            <b><label style={{float: "left", position: "relative", top: "15%", marginRight: "10px"}}><i class="fa fa-solid fa-filter"></i> Sort by</label></b>
            <select style={{backgroundColor: "#0a0908", color: "#F2F4F3", width: "160px"}}
              className="form-select"
              aria-label="Sort by"
